...
const inputPath = path.join(projectRoot, "all_testnet.json");
const outputPath = path.join(projectRoot, "all_testnet_wei.json");
...
console.log(`Wrote ${weiData.length} entries to all_testnet_wei.json`);
