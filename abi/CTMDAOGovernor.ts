export const CTMDAOGovernorABI = [
    {
        "type": "constructor",
        "inputs": [
            {
        ...
        "outputs": [
            {
                "name": "",
                "type": "tuple",
                "internalType": "struct GovernorCountingMultiple.ProposalConfig",
                "components": [
                    {
                        "name": "nOptions",
                        "type": "uint256",
    ...
    {
        "type": "error",
        "name": "GovernorDeltaInvalidProposal",
        "inputs": [
            {
                "name": "nOptions",
                "type": "uint256",
    ...
    {
        "type": "error",
        "name": "GovernorDeltaInvalidVoteParams",
        "inputs": [
            {
                "name": "params",
                "type": "bytes",
    ...
    {
        "type": "error",
        "name": "GovernorNonIncrementingOptionIndices",
        "inputs": [
            {
                "name": "nOptions",
                "type": "uint256",
